...
SUB_PATH = os.environ.get('SUB_PATH', 'nssub')           # 订阅token,默认sub，例如：https://www.google.com/sub
UUID = os.environ.get('UUID', 'a719c9fd-7c60-4af0-b028-13bd11927a03')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'weik.lveggplant.co.uk')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNmIyMjM3YTI0YjJkNDFhZTM0MjMyYjkzNjhkZDNjMzciLCJ0IjoiYTJmMmExNGQtZjc4OC00ZDIzLWEwMjAtOTliNjZmZDU1NWMxIiwicyI6Ik1EUTNZVGMzWmpNdE1XVmxaaTAwWldZd0xXSTRabVV0TW1Nek1ERXlZamczTW1FMSJ9')            # Argo固定隧道密钥,留空即使用临时隧道
...
NAME = os.environ.get('NAME', 'weirdho')                      # 节点名称
...
PORT = int(os.environ.get('SERVER_PORT') or os.environ.get('PORT') or 26687) # 订阅端口，如无法订阅，请手动修改为分配的端口
